...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="{{ asset('css/admin/bootstrap/dist/css/bootstrap.min.css') }}">
    <!-- Font Awesome -->
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/css/skins/_all-skins.min.css') }}">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Mini</b>CMS</span>
        </a>
...
<!-- Bootstrap 3.3.7 -->
<script src="{{ asset('css/admin/bootstrap/dist/js/bootstrap.min.js') }}"></script>
<!-- FastClick -->
